...
module Config
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/1.8/i686-darwin10.6.0")
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/hamhei/.rvm/rubies/ruby-1.8.7-p334")
  CONFIG["ruby_install_name"] = "ruby"
  CONFIG["RUBY_INSTALL_NAME"] = "ruby"
  CONFIG["RUBY_SO_NAME"] = "ruby"
  CONFIG["MANTYPE"] = "doc"
  CONFIG["NROFF"] = "/usr/bin/nroff"
  CONFIG["configure_args"] = " '--prefix=/Users/hamhei/.rvm/rubies/ruby-1.8.7-p334' '--enable-shared' '--disable-install-doc'"
  CONFIG["vendordir"] = "$(libdir)/ruby/vendor_ruby"
  CONFIG["sitedir"] = "$(libdir)/ruby/site_ruby"
  CONFIG["sitearch"] = "i686-darwin10.6.0"
  CONFIG["arch"] = "i686-darwin10.6.0"
  ...
  CONFIG["target"] = "i686-apple-darwin10.6.0"
  CONFIG["host_os"] = "darwin10.6.0"
  CONFIG["host_vendor"] = "apple"
  CONFIG["host_cpu"] = "i686"
  CONFIG["host"] = "i686-apple-darwin10.6.0"
