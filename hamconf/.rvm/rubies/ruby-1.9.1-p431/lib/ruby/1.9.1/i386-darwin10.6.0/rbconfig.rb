...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/1.9.1/i386-darwin10.6.0")
  DESTDIR = '' unless defined? DESTDIR
  CONFIG = {}
  CONFIG["DESTDIR"] = DESTDIR
  CONFIG["INSTALL"] = '/usr/bin/install -c'
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/hamhei/.rvm/rubies/ruby-1.9.1-p431")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/hamhei/.rvm/rubies/ruby-1.9.1-p431' '--enable-shared' '--disable-install-doc'"
  ...
  CONFIG["sitearch"] = "i386-darwin10.6.0"
  CONFIG["arch"] = "i386-darwin10.6.0"
  ...
  CONFIG["CC"] = "gcc"
  CONFIG["target_os"] = "darwin10.6.0"
  CONFIG["target_vendor"] = "apple"
  CONFIG["target_cpu"] = "i386"
  CONFIG["target"] = "i386-apple-darwin10.6.0"
  CONFIG["host_os"] = "darwin10.6.0"
  CONFIG["host_vendor"] = "apple"
  CONFIG["host_cpu"] = "i386"
  CONFIG["host"] = "i386-apple-darwin10.6.0"
  CONFIG["build_os"] = "darwin10.6.0"
  CONFIG["build_vendor"] = "apple"
  CONFIG["build_cpu"] = "i386"
  CONFIG["build"] = "i386-apple-darwin10.6.0"
  CONFIG["TEENY"] = "1"
  CONFIG["MINOR"] = "9"
  CONFIG["MAJOR"] = "1"
